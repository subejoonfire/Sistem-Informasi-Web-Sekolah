	...
	function simpan_guru(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_guru->simpan_guru($nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$jabatan,$kelas,$photo);
					...
					$this->m_guru->simpan_guru_tanpa_img($nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$jabatan,$kelas);
					echo $this->session->set_flashdata('msg','success');
					redirect('admin/guru');
				}
	...
	function update_guru(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$jabatan=strip_tags($this->input->post('xjabatan'));
							$kelas = strip_tags($this->input->post('xkelas'));
							$this->m_guru->update_guru($kode,$nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$jabatan,$kelas,$photo);
	                    ...
	                    redirect('admin/guru');
							...
							$jabatan=strip_tags($this->input->post('xjabatan'));
							$kelas = strip_tags($this->input->post('xkelas'));
							$this->m_guru->update_guru_tanpa_img($kode,$nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$jabatan,$kelas);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/guru');
	            } 
